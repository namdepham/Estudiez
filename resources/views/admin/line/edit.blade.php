                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('line.update', $data) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                @if ($errors->any())
                                    ...
                                    <div class="row form-group justify-content-center">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" id="type" name="phonenumber"
                                                   placeholder="Phone number" class="form-control" value="{{$data->phonenumber}}">                                        </div>
                                    </div>
                                </div>
